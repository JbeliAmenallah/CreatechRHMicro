...
public class FicheDePaieController {
    ...
    public ResponseEntity<List<FicheDePaieDTO>> getFichesDePaieByContactId(@PathVariable Long contactId) {
        List<FicheDePaieDTO> fichesDePaie = ficheDePaieService.getFicheDePaieByContactId(contactId);
        return new ResponseEntity<>(fichesDePaie, HttpStatus.OK);
    }
